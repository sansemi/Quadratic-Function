...
\usepackage[scale=1.24]{beamerposter, ngerman} 
\usetheme{confposter}
...
\title{Informatik f\"ur Sch\"uler} % Poster title
...
\begin{itemize}
\item $f(x) = ax^2+bx+c$ wird die quadratischeGleichung genannt\textbf{standard form}.
